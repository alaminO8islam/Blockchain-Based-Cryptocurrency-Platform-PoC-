...
This is a Proof of Concept (PoC) project developed by a team of 5 members as part of our academic coursework in Computer Science & Engineering.

Our platform simulates the core functionalities of a blockchain-based cryptocurrency system — including secure transaction handling, wallet management, consensus logic, and decentralized ledger storage.

---

## 🎥 Project Demo: RAT – Buy & Sell Digital Assets

Explore how the RAT cryptocurrency platform enables secure digital asset transactions using blockchain technology.

🔗 [Watch the full walkthrough on YouTube](https://youtu.be/MEWjkqZoE0Q?si=R8aS-7Ene8eu8OBG)
